...
## What Belongs Here
Use this map for market microstructure, liquidity, adverse selection, inventory costs, order processing costs, price impact, and trading frictions.
...
- Review the main findings of the literature on Bid-Ask Spreads.
