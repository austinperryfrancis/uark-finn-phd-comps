...
## What Belongs Here
Use this map for SDF existence, Euler equations, Hansen-Jagannathan bounds, risk premia, factor models, and the connection between pricing kernels and expected returns.
...
- Review the main findings of the literature on Stochastic Discount Factors.
