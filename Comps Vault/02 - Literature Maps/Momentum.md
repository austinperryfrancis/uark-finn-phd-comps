...
## What Belongs Here
Use this map for return continuation, behavioral explanations, risk-based explanations, crashes, implementation, and cross-sectional asset pricing tests.
...
- Review the main findings of the literature on Momentum.
