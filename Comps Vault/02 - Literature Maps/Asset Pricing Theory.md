...
## What Belongs Here
Use this map for CAPM, ICAPM, consumption models, SDF logic, beta representations, no-arbitrage pricing, and equilibrium expected returns.
...
- Review the main findings of the literature on Asset Pricing Theory.
